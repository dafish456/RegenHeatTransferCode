function [cstar, isp, M, gamma, T, rho, mu, Pr, Mw, k] = CEA(Pc, OF)
addpath('C:\Users\visha\Documents\Liquid Engine Project During Agile Internship\CEA');
...
inp('fuel_t') = 273.15;               % Fuel inlet temperature
